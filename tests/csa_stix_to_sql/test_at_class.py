...
class TestStixToSql(unittest.TestCase, object):
    ...
    def test_ipv4_query(self):
        interface = csa_translator.Translator(dialect='at', rows=10)
        ...
        where_statement = "WHERE (initiator.host.address = '192.168.122.84' OR target.host.address = '192.168.122.84') OR (initiator.host.address = '192.168.122.83' OR target.host.address = '192.168.122.83') PARTITIONED EVERY 10 ROWS"
...
#         assert query['sql_queries'] == [selections + from_statement + where_statement]
    ...
    def test_url_query(self):
        ...
        options = {}
        query = interface.transform_query(input_arguments, options)
        where_statement = "WHERE url = 'http://www.testaddress.com' PARTITIONED EVERY 10 ROWS"
    ...
    def test_mac_address_query(self):
        ...
        options = {}
        query = interface.transform_query(input_arguments, options)
        where_statement = "WHERE false PARTITIONED EVERY 10 ROWS"
    ...
    def test_domain_query(self):
        ...
        options = {}
        query = interface.transform_query(input_arguments, options)
        where_statement = "WHERE (initiator.id = 'example.com' OR target.host.address = 'example.com' OR initiator.name = 'example.com' OR observer.host.address = 'example.com' OR action = 'example.com' OR api.name = 'example.com') PARTITIONED EVERY 10 ROWS"
    ...
    #     where_statement = "WHERE (Network.A = '192.168.1.1' OR Network.B = '192.168.1.1') OR (Link.A = '00-00-5E-00-53-00' OR Link.B = '00-00-5E-00-53-00')"
    ...
    #     where_statement = "WHERE (Link.A = '00-00-5E-00-53-00' OR Link.B = '00-00-5E-00-53-00') AND (Network.A = '192.168.1.1' OR Network.B = '192.168.1.1')"
    ...
    def test_file_query(self):
        ...
        options = {}
        query = interface.transform_query(input_arguments, options)
        where_statement = "WHERE filename = 'some_file.exe' PARTITIONED EVERY 10 ROWS"
    ...
    def test_user_account_query(self):
        ...
        options = {}
        query = interface.transform_query(input_arguments, options)
        where_statement = "WHERE (initiator.id = 'root' OR target.id = 'root') PARTITIONED EVERY 10 ROWS"
